...
export default function About() {
    ...
    return (
        <div className="flex w-full max-h-fit justify-center items-center bg-darkbase">
            <div className="flex max-w-5xl flex-col py-48 px-10">
                <div className="flex rg:flex-row flex-col gap-6 h-max">
                    <div className="flex h-auto">
                        <img src="/alex-knight-j4uuKnN43_M-unsplash.jpg" className="rg:hidden w-full object-cover rounded-lg" alt="pcfoto1" />
                        <img src="/mohammad-rahmani-N5bT5RctFZ8-unsplash.jpg" className="object-cover max-w-md hidden rg:flex rounded-lg" alt="pcfoto2" />
                    </div>
