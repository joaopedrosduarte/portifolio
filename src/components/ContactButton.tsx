...
export default function ContactButton({
  ...
  return (
    <div className="flex mb4:flex-row flex-col items-center mb4:text-left text-center gap-2">
      <div className={`${theme == "light"? "shadow-black/10" : "shadow-black/40"} w-14 h-14 bg-darkbase transition-shadow duration-300 shadow-baseblured rounded-full items-center flex justify-center`}>
        {component}
      </div>
