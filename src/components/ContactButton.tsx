...
export default function ContactButton({ component, title, result, link="" }:ContactButton) {
    return(
        <div className="flex mb4:flex-row flex-col items-center mb4:text-left text-center gap-2">
            <div className="w-14 h-14 bg-darkbase transition-shadow duration-300 shadow-baseblured hover:shadow-shinny hover:shadow-blue-700 rounded-full items-center flex justify-center">
                {component}
            </div>
