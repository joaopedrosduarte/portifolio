...
export default function TechStacks({ webTechs, devopsTechs }: TechStacksProps) {
  return (
    <div className="pl-2 flex flex-col w-full pt-16 mt-20 border-t-2 border-lightbase border-0 gap-8 items-center align-middle">
      <div className="w-full align-middle justify-center flex">
        <h2 className="w-max text-center pl-[2px] font-medium text-darkmode-maintext text-2xl">
          Tech Stacks
        </h2>
      </div>
      <div className="border-l-2 rg:border-0 border-lightgray rg:pl-0 pl-6 gap-8 flex flex-col">
        <div className="flex-col flex rg:flex-row gap-4 rg:gap-0 justify-center pr-[31px]">
          <h2 className="font-light pr-6 py-2 rg:border-r border-lightgray text-darkmode-maintext text-xl">
            Web stack
          </h2>
