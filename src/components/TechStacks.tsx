    ...
    <div className="flex w-full items-center justify-center">
      <div className="flex flex-col max-w-5xl w-full gap-12 px-10 pt-32 pb-8">
        <div className="w-full flex flex-col gap-2 mb4:items-start items-center">
          ...
          <h2 className={`${theme == "light"? "text-zinc-700" : "text-darkmode-maintext" } font-semibold mb4:text-left text-center text-xl pb-4`}>
            As principais tecnologias que uso no meu dia a dia.
          </h2>
        </div>
        <div className={`${theme == "light"? "border-zinc-400" : "border-darkmode-lightbase" } border-l-2 rg:border-0 border-lightgray rg:pl-0 pl-6 gap-8 w-max flex flex-col`}>
          <div className="flex-col flex rg:flex-row gap-4 rg:gap-0 pr-[31px]">
            <h2 className={`${theme == "light"? "text-zinc-700 border-lightmode-lightgray" : "text-darkmode-maintext border-darkmode-lightbase"} font-normal pr-[57.5px] py-2 rg:border-r-2 text-darkmode-maintext text-xl`}>
              Web stack
            </h2>
          ...
          <div className="flex-col flex rg:flex-row gap-4 rg:gap-0">
            <h2 className={`${theme == "light"? "text-zinc-700 border-lightmode-lightgray" : "text-darkmode-maintext border-darkmode-lightbase"} rg:max-w-[158px] rg:w-full font-normal pr-6 py-2 rg:border-r-2 border-lightgray text-darkmode-maintext`}>
              DevOps stack
            </h2>
