...
export default function Hero() {
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex flex-col max-w-5xl w-full items-center px-10 pt-72 pb-48">
        <div className="w-full gap-16 flex flex-col justify-between items-center">
          ...
          <div className="w-full flex mb3:flex-row flex-col gap-5 justify-between align-middle">
            <button className="px-4 py-3 justify-center items-center bg-blue-600 duration-300 transition-shadow hover:shadow-blue-600 hover:shadow-[0px_2px_40px_-4px] rounded-lg flex gap-2">
